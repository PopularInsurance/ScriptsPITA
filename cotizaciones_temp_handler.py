...
Helper para:
 - Agrupar PDFs colocados en Cotizaciones_temp (por ID en filename o prefijo)
 ...
 - Guardar resultados en Resultados_Pendientes/ y Resultados_TXT/
...
# Intentar importar OCR y funciones de verificación/merge desde el repo
try:
...
# Carpetas (mantener consistencia con el resto del repo)
CARPETAS = {
    "temp": "Cotizaciones_temp",
...
# merge_pdfs now imported from verificar_prestamos_v3
...
def main(dry_run=False):
    ...
    if merge_pdfs is None:
        print("ERROR: merge_pdfs no disponible. Asegúrate que verificar_prestamos_v3 tenga PyPDF2 instalado.")
        return 1
